...
public class Ducto extends PiezaImpl {
	
	public Ducto(Forma forma, Size size, Integer largo, UnionT initialUnion, UnionT finalUnion,Integer cantidad, Calibre calibre) {
		this.setId(0);
		this.setForma(forma);
		this.setSize(size);
		this.setLargo(largo);
	...
	public Ducto(Integer id, Forma forma, Size size, Integer largo, UnionT initialUnion, UnionT finalUnion,Integer cantidad, Calibre calibre) {
		this.setId(id);
		this.setForma(forma);
		this.setSize(size);
		this.setLargo(largo);
	...
	public void crearFiguras() {
		...
		List<Figura> ducto = new ArrayList<>();	
		this.setPieza(ducto);
		this.addFigura(figura);
	}

	public String toString() {
		return String.format("Ducto(%s)", super.toString());
	}
